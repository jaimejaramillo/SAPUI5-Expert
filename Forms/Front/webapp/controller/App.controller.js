...
sap.ui.define([
    ...
    */
    function (Controller, JSONModel, Core, MessagePopover, Element, MessageItem, library, Message) {
        ...
        return Controller.extend("ns.Front.controller.App", {
            ...
            createMessagePopover: function () {
                ...
                this.oMP = new MessagePopover({
                    activeTitlePress: function (oEvent) {
                        ...
                        let oPage = this.getView().byId("employeePage");
            ...
            checkInputConstraints: function (group, oInput) {
                ...
                switch (group) {
                    case "GR1":
                        ...
                        type = MessageType.Error;
                        description = "The value of the email field should be a valid email address.";
                        sValueState = "Error";
                        break;
                    case "GR2":

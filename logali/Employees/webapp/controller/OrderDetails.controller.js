...
sap.ui.define([
    ...
    function (Controller, History, MessageBox, Filter, FilterOperator) {
        ...
        function _onObjectMatched(oEvent) {
            ...
            this.getView().bindElement({
                ...
                events: {
                    dataReceived: function (oData) {
                        _readDependences.bind(this)(oData.getParameter("data").OrderID, oData.getParameter("data").EmployeeID);
                    }.bind(this)
                }
            });
            ...
            if (objContext) {
                _readDependences.bind(this)(objContext.OrderID, objContext.EmployeeID);
            }

        };

        function _readDependences(orderId, employeeId) {
        ...
        return Controller.extend("ns.Employees.controller.OrderDetails", {
            ...
            onFileBeforeUpload: function (oEvent) {
                ...
                let oCustomerHeaderSlug = new sap.m.UploadCollectionParameter({
                    name: "slug",
                    value: oContext.OrderID + ";" + this.getOwnerComponent().SapId + ";" + oContext.EmployeeID + ";" + fileName
                });
            ...
            onFileChange: function (oEvent) {
                ...
                //Header Token X-CSRF - Cross-site request forgery
